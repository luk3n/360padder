...
namespace XInputWrapper.Xbox
{
    ...
    {
        BATTERY_TYPE_DISCONNECTED = 0x00,    // Device disconnected
        BATTERY_TYPE_WIRED = 0x01,    // Wired. There's no battery
        BATTERY_TYPE_ALKALINE = 0x02,    // Alkaline 
        BATTERY_TYPE_NIMH = 0x03,    // Nickel Metal Hydride
        BATTERY_TYPE_UNKNOWN = 0xFF,    // Unknown battery type
    };


    // Not valid for wired devices
